...
export default function Home() {
  return (
    <main className="bg-linear-to-br from-slate-50 via-purple-50/30 to-blue-50 relative overflow-hidden">
      {/* Decorative background elements */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -right-40 w-96 h-96 bg-purple-200/30 rounded-full blur-3xl animate-float"></div>
        <div className="absolute top-1/2 -left-32 w-80 h-80 bg-blue-200/30 rounded-full blur-3xl animate-float-delayed"></div>
        <div className="absolute bottom-20 right-1/4 w-64 h-64 bg-indigo-200/30 rounded-full blur-3xl animate-float-slow"></div>
      </div>
      <div className="relative z-10 container mx-auto px-6 py-10 flex flex-col items-center justify-center">
        ...
        <h1 className="text-center mb-6 animate-fade-in-up animation-delay-200">
          <span className="block text-5xl md:text-7xl font-bold text-gray-900 mb-2 tracking-tight">
            Find Your Dream Job,
          </span>
        ...
        {/* Subtitle */}
        <p className="text-center text-gray-600 text-lg md:text-xl max-w-2xl mb-12 leading-relaxed animate-fade-in-up animation-delay-300">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-6 mb-20 animate-fade-in-up animation-delay-400">
          <Link
            href={"/jobs"}
            className="group relative px-8 py-4 bg-linear-to-r from-indigo-600 to-purple-600 text-white font-semibold rounded-xl shadow-xl shadow-purple-500/25 hover:shadow-2xl hover:shadow-purple-500/40 transition-all duration-300 hover:scale-105 flex items-center gap-3"
          >
            Browse Jobs
